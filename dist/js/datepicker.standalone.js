  ...
  _createClass(MaterialDateTimePicker, [{
    ...
    value: function set(value, opts) {
      ...
      if (!opts || !opts.silent) {
        ...
        this.trigger(['data', 'change'].concat(evts).join(' '), this.value, this);
      }
    }
