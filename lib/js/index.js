...
class MaterialDateTimePicker extends Events {
  ...
  delegateEvents() {
    this.$('.js-cancel')
      .addEventListener('click', () => this.clickCancel());
    this.$('.js-ok')
      .addEventListener('click', () => this.clickSubmit());

    this.$(`.${this.options.styles.clockNum}`).forEach(el => {
      el.addEventListener('click', (e) => this.clickClock(e));
    });

    this.$('.c-datepicker__clock--am')
      .addEventListener('click', (e) => this.clickAm(e));
    this.$('.c-datepicker__clock--pm')
      .addEventListener('click', (e) => this.clickPm(e));
